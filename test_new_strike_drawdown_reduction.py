...
print("========================================================================================================================")
print("TESTING DRAWDOWN REDUCTION STRATEGIES FOR NEW STRIKE SELECTION MODEL")
print("========================================================================================================================")

baseline = simulate_scenario(stop_loss_pct=None, target_pct=None)
sl30     = simulate_scenario(stop_loss_pct=0.30, target_pct=None)
...
scenarios = [
    ...
    ('-30% Premium Stop Loss', sl30),
    ('-40% Premium Stop Loss', sl40),
    ('-50% Premium Stop Loss', sl50)
]
