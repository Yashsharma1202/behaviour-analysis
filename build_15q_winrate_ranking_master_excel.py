...
print("==========================================================================================")
print("BUILDING 15-QUARTER WINDOW WIN RATE RANKING MASTER WORKBOOK")
print("==========================================================================================")
...
for idx, sym in enumerate(SYMBOLS, 1):
    ...
    # Evaluate performance SPECIFICALLY ACROSS THE 15-QUARTER WINDOW
    wins_15q = 0
    losses_15q = 0
    trades_15q = 0
    stock_15q_pnl = 0.0
    ...
    win_rate_15q = round((wins_15q / trades_15q) * 100, 2) if trades_15q > 0 else 0.0
    ...
    ranking_data.append({
        ...
        "trades_15q": trades_15q,
        "wins_15q": wins_15q,
        "losses_15q": losses_15q,
        "avg_ret_15q": avg_ret_15q,
...
# Sort strictly by 15-Quarter Win Rate % descending, then 15-Quarter Net P&L descending
df_all = df_all.sort_values(['win_rate_15q', 'pnl_15q'], ascending=[False, False]).reset_index(drop=True)
...
out_path = ROOT / "Nifty211_All_Stocks_15_Quarters_WinRate_Ranking_Master.xlsx"
...
def write_ranking_sheet(ws, sheet_title, df_sheet):
    ...
    ws["A1"] = f"NIFTY 211 STOCKS - {sheet_title.upper()} RANKING BY 15-QUARTER WIN RATE %"
    ...
    headers = [
        ...
        "Position Window", "15-Quarter Win Rate %", "15-Quarter Wins", "15-Quarter Losses",
        "15-Quarter Avg Return %", "Margin Capital (₹)", "15-Quarter Net P&L (₹)"
    ]
    ...
    for r_idx, r in enumerate(df_sheet.to_dict('records'), start=rank_start_row+2):
        ...
        c_wr = ws.cell(row=r_idx, column=7, value=f"{r['win_rate_15q']}%")
        ...
        ws.cell(row=r_idx, column=8, value=r['wins_15q']).border = border_thin
        ws.cell(row=r_idx, column=8).alignment = Alignment(horizontal="center")
        
        ws.cell(row=r_idx, column=9, value=r['losses_15q']).border = border_thin
        ws.cell(row=r_idx, column=9).alignment = Alignment(horizontal="center")
        
        ws.cell(row=r_idx, column=10, value=f"{r['avg_ret_15q']}%").border = border_thin
        ...
        c_p = ws.cell(row=r_idx, column=12, value=f"₹{r['pnl_15q']:,.2f}")
        c_p.border = border_thin; c_p.alignment = Alignment(horizontal="right")
...
wb.save(out_path)
print(f"  • Successfully generated: Nifty211_All_Stocks_15_Quarters_WinRate_Ranking_Master.xlsx")
print("==========================================================================================")
print("15-QUARTER WINDOW WIN RATE RANKING MASTER WORKBOOK CREATED SUCCESSFULLY!")
print("==========================================================================================")
