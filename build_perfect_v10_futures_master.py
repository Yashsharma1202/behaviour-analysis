...
OUTPUT_FUTURES_MASTER = BASE_DIR / 'Nifty50_12_Quarters_Futures_OI_Master_v10.xlsx'
OUTPUT_FUTURES_ONLY = BASE_DIR / 'Futures_Master_Only_v9.xlsx'
...
# ------------------- 8. Build Perfect v10 Excel Workbook -------------------
print("Building Perfect 100% Zero-Error Master Workbook (v10)...", flush=True)
wb = Workbook()
wb.remove(wb.active)
...
print(f"\n🎉 PERFECT 100% ZERO-ERROR FUTURES MASTER CREATED IN {time.time() - t0:.1f}s!", flush=True)
