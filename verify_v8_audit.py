...
V8_PATH = BASE_DIR / 'Nifty50_12_Quarters_Futures_OI_Master_v8.xlsx'

xl = pd.ExcelFile(V8_PATH, engine='openpyxl')
df_trades = xl.parse('All_12Q_Futures_Trades')
df_exec   = xl.parse('Exec_12Q_Combined_Summary')

print("==========================================")
print("VERIFYING PERFECT V8 FUTURES MASTER WORKBOOK")
print("==========================================")
