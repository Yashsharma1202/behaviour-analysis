...
print("==========================================================================================")
print("BUILDING PAST 4 QUARTERS MASTER WORKBOOKS WITH 100% EMPIRICAL HISTORICAL WIN RATES")
print("==========================================================================================")
...
for idx, sym in enumerate(SYMBOLS, 1):
    ...
    # Calculate Real Empirical Historical Win Rate across all available quarters
    emp_wins_long = 0
    emp_wins_short = 0
    total_q_count = len(q_dates_history)
    ...
    real_long_wr = round((emp_wins_long / total_q_count) * 100, 1) if total_q_count > 0 else 50.0
    real_short_wr = round((emp_wins_short / total_q_count) * 100, 1) if total_q_count > 0 else 50.0
    real_best_wr = max(real_long_wr, real_short_wr)
    
    empirical_stock_stats[sym] = {
        "long_wr": real_long_wr, "short_wr": real_short_wr, "best_wr": real_best_wr,
        "n_quarters": f"{n_quarters} Quarters", "trading_status": trading_status, "window": window_str
    }
    ...
    for q_idx, (q_name, default_d_str) in enumerate(quarters_list):
        ...
        base_quarter_trades[q_name].append({
            ...
            "window": window_str,
            "win_rate_long": real_long_wr,
            "win_rate_short": real_short_wr,
            "win_rate_best": real_best_wr,
...
def generate_past_4_quarters_workbook_v4(mode_name, filename):
    ...
    for q_name, _ in quarters_list:
        ...
        for r in raw_t:
            ...
            if mode_name == "LONG": buy_p = p_e; sell_p = p_x; wr = r['win_rate_long']
            elif mode_name == "SHORT": buy_p = p_x; sell_p = p_e; wr = r['win_rate_short']
            else:
                if long_gross >= short_gross: buy_p = p_e; sell_p = p_x; wr = r['win_rate_long']
                else: buy_p = p_x; sell_p = p_e; wr = r['win_rate_short']
            ...
            calc_t.append({
                "sym": r['sym'], "trading_status": r['trading_status'], "win_rate": wr,
    ...
    cards = [
        ...
        ("4-QTR EMPIRICAL WIN RATE", f"{cum_wr_all}%", "C3:D4", "C3"),
    ...
    # 4. ALL 211 STOCKS WIN RATE RANKING TABLE (EMPIRICAL WIN RATES)
    ...
    ws_sum.cell(row=rank_start_row, column=1, value="ALL 211 STOCKS EMPIRICAL HISTORICAL WIN RATE & PERFORMANCE RANKING").font = hdr_font
    ...
    headers_rank = ["Rank", "Stock Symbol", "Action Status", "History", "Position Taking Window", "Empirical Win Rate %", "Recent Quarter Net P&L (₹)"]
    ...
    for q_name, _ in quarters_list:
        ...
        headers = [
            ...
            "Historical Quarters Count", "Position Taking Window", "Empirical Win Rate %",
        ...
        for r_idx, r in enumerate(q_trades, start=4):
            ...
            if mode_name == "LONG": buy_p = p_e; sell_p = p_x; strat = "FUTURE LONG"; wr = r['win_rate_long']
            elif mode_name == "SHORT": buy_p = p_x; sell_p = p_e; strat = "FUTURE SHORT"; wr = r['win_rate_short']
            else:
                if long_gross >= short_gross: buy_p = p_e; sell_p = p_x; strat = "FUTURE LONG"; wr = r['win_rate_long']
                else: buy_p = p_x; sell_p = p_e; strat = "FUTURE SHORT"; wr = r['win_rate_short']
            ...
            ws_q.cell(row=r_idx, column=8, value=f"{wr}%")
...
generate_past_4_quarters_workbook_v4("LONG", "Nifty211_Past_4_Quarters_Futures_LONG_Master.xlsx")
generate_past_4_quarters_workbook_v4("SHORT", "Nifty211_Past_4_Quarters_Futures_SHORT_Master.xlsx")
generate_past_4_quarters_workbook_v4("COMBINED BEST", "Nifty211_Past_4_Quarters_Combined_Best_Futures_Master_v3.xlsx")

print("==========================================================================================")
print("ALL 3 PAST 4 QUARTERS MASTER WORKBOOKS RE-BUILT WITH 100% EMPIRICAL WIN RATES & TRADE OUTCOMES!")
print("==========================================================================================")
