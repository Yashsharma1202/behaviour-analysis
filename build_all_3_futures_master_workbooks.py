...
print("==========================================================================================")
print("BUILDING ALL 3 FUTURES MASTER EXCEL WORKBOOKS (LONG, SHORT & COMBINED BEST)")
print("==========================================================================================")
...
def generate_master_workbook(mode_name, filename):
    ...
    headers_70 = ["Stock Symbol", "Strategy", "Position Taking Window", "Historical Win Rate %", "Net Realised P&L (₹)"]
...
generate_master_workbook("COMBINED BEST", "Nifty211_Recent_Quarter_Combined_Best_Futures_Master_Final.xlsx")

print("==========================================================================================")
print("ALL 3 MASTER EXCEL WORKBOOKS CREATED SUCCESSFULLY!")
print("==========================================================================================")
