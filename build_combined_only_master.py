...
print("==========================================================================================")
print("BUILDING ONLY COMBINED RESULT QUARTERLY PERFORMANCE MASTER WORKBOOK")
print("==========================================================================================")
...
out_path_combined_only = ROOT / "Nifty211_Combined_Only_Performance_Master.xlsx"
out_path_combined_alt = ROOT / "Nifty211_Combined_Performance_Master.xlsx"

wb = openpyxl.Workbook()
ws = wb.active
ws.title = "ALL QUARTERS COMBINED"
...
df_cat = pd.DataFrame(combined_data_store)
...
ws["A1"] = "NIFTY 211 COMBINED QUARTERLY PERFORMANCE MASTER (ALL HISTORICAL QUARTERS)"
...
cards = [
    ...
    ("AVERAGE COMBINED RETURN %", f"{avg_ret_q}%", "G3:I4", "G3"),
    ("AVERAGE COMBINED WIN RATE %", f"{avg_wr_q}%", "J3:L4", "J3"),
    ("TOTAL COMBINED NET P&L", f"₹{tot_pnl_q:,.2f}", "M3:O4", "M3")
]
...
rank_start_row = 6
ws.cell(row=rank_start_row, column=1, value=f"ALL {len(df_sorted)} STOCKS RANKED BY COMBINED HISTORICAL QUARTERLY NET REALISED P&L").font = hdr_font
...
saved_paths = []
for target_path in [out_path_combined_only, out_path_combined_alt]:
    try:
        wb.save(target_path)
...
print("==========================================================================================")
print(f"ONLY COMBINED RESULT MASTER CREATED SUCCESSFULLY! ({len(saved_paths)} files saved)")
print("==========================================================================================")
