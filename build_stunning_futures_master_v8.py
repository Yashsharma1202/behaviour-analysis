...
OUTPUT_FUTURES_MASTER = BASE_DIR / 'Nifty50_12_Quarters_Futures_OI_Master_v8.xlsx'
OUTPUT_FUTURES_ONLY = BASE_DIR / 'Futures_Master_Only_v7.xlsx'
...
for idx, row in df_cons_trades.iterrows():
    ...
    # Perfect Cent Precision Formula:
...
# ------------------- 8. Build Perfect v8 Excel Workbook -------------------
print("Building Perfect 100% Precision Master Workbook (v8)...", flush=True)
wb = Workbook()
wb.remove(wb.active)
