...
OUTPUT_FUTURES_MASTER = BASE_DIR / 'Nifty50_12_Quarters_Futures_OI_Master_v12.xlsx'
OUTPUT_FUTURES_ONLY = BASE_DIR / 'Futures_Master_Only_v11.xlsx'
...
# ------------------- 5. Per-Quarter Fund & Correct Chronological Drawdown Summaries -------------------
quarter_summaries = []

for qtr in quarters_order:
    # Sort trades chronologically by Entry Date & Trade No!
...
# ------------------- 8. Build Perfect v12 Excel Workbook with Correct Drawdowns -------------------
print("Building Master Workbook with Correct Chronological Drawdown Charts (v12)...", flush=True)
wb = Workbook()
wb.remove(wb.active)
...
c_sec = ws_exec['A6']
c_sec.value = "QUARTER-BY-QUARTER PERFORMANCE COMPARISON & CHRONOLOGICAL DRAWDOWN (ALL 12 QUARTERS)"
...
c_ctitle = ws_conc['A1']
c_ctitle.value = "CAPITAL EFFICIENCY & CONCURRENT OPEN SCRIPT ANALYSIS (ALL 12 QUARTERS)"
...
# --- SHEET 3-14: 12 SEPARATE QUARTER SHEETS WITH CORRECT CHRONOLOGICAL DRAWDOWN CHARTS ---
qtr_card_labels = [
...
for qtr in quarters_order:
    ...
    # EMBED CORRECT CHRONOLOGICAL DRAWDOWN CHART ON EVERY QUARTER SHEET
    chart_q = LineChart()
...
print(f"\n🎉 PERFECT V12 MASTER WORKBOOK WITH CORRECT DRAWDOWN CHARTS CREATED IN {time.time() - t0:.1f}s!", flush=True)
