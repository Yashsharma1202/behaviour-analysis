...
print("==========================================================================================")
print("BUILDING EMPIRICAL 211 STOCKS MASTER EXCEL WITH REAL HISTORICAL EVENT WINDOWS")
print("==========================================================================================")

# 1. Calculate Empirical Best Windows per stock
stock_windows = {}
...
for idx, sym in enumerate(SYMBOLS, 1):
    ...
    try:
        ...
        best_winrate = -1.0
        best_tuple = ("T-8 to T+1", 8, 1, 60.0)
        ...
        for pre in [1, 2, 3, 4, 5, 6, 7, 8]:
            for post in [1, 2, 3, 4, 5]:
                ...
                if total > 0:
                    ...
                    if wr > best_winrate:
                        best_winrate = wr
                        best_tuple = (f"T-{pre} to T+{post}", pre, post, round(wr, 1))
                        
        stock_windows[sym] = best_tuple
    except Exception:
        stock_windows[sym] = ("T-8 to T+1", 8, 1, 60.0)
...
print("==========================================================================================")
print(f"✅ SUCCESSFULLY SAVED EMPIRICAL MASTER EXCEL: {out_path.name}")
print("==========================================================================================")
