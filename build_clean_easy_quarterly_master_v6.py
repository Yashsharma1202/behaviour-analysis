...
print("==========================================================================================")
print("BUILDING CLEAN & EASY QUARTERLY PERFORMANCE MASTER V6 (INCLUDING ALL QUARTERS COMBINED SHEET)")
print("==========================================================================================")
...
saved_paths = []
target_list = [
    ROOT / "Nifty211_All_Quarters_Performance_Master.xlsx",
    out_path_clean, out_path_dynamic, out_path_master
]
...
print("==========================================================================================")
print(f"CLEAN & EASY QUARTERLY PERFORMANCE MASTER V6 CREATED SUCCESSFULLY! ({len(saved_paths)} files saved)")
print("==========================================================================================")
