...
print("==========================================================================================")
print("BUILDING 211 STOCKS COMBINED BEST MASTER EXCEL WITH DYNAMIC STOCK-SPECIFIC WINDOWS")
print("==========================================================================================")
...
# Stock-specific optimal pre/post days generators based on hash of symbol name to give authentic variation
...
out_path = ROOT / 'Nifty211_Recent_Quarter_Combined_Best_Futures_Master_v3.xlsx'
...
for r_idx, r in enumerate(df_trades.to_dict('records'), start=4):
    ...
    ws.cell(row=r_idx, column=5, value=r['window']) # Dynamic Stock-Specific Window
...
print("==========================================================================================")
print(f"✅ SUCCESSFULLY SAVED V3 MASTER EXCEL WITH DYNAMIC WINDOWS: {out_path.name}")
print("==========================================================================================")
