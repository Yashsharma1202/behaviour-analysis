...
print("==========================================================================================")
print("BUILDING PAST 15 QUARTERS COMBINED BEST FUTURES MASTER WORKBOOK")
print("==========================================================================================")
...
out_path = ROOT / "Nifty211_Past_15_Quarters_Combined_Best_Futures_Master.xlsx"
...
print("\nINDIVIDUAL QUARTER COMBINED BEST BREAKDOWN ACROSS ALL 15 QUARTERS:")
print("-" * 90)
for q_name, _ in quarters_list:
    st = q_stats[q_name]
...
print("-" * 90)
print(f"  15-QUARTER CUMULATIVE: All Stocks Win Rate = {cum_wr_all}% | Qualified Win Rate = {cum_wr_q}% | Total P&L = ₹{cum_all_pnl:,.2f}")

# Title
ws_sum.merge_cells("A1:AE1")
ws_sum["A1"] = "NIFTY 211 STOCKS - PAST 15 QUARTERS COMBINED BEST FUTURES SUMMARY"
...
# Side-by-Side 15-Quarter Matrix
ws_sum.cell(row=7, column=1, value="PAST 15 QUARTERS SIDE-BY-SIDE MATRIX (ALL VS QUALIFIED)").font = hdr_font
ws_sum.cell(row=7, column=1).fill = hdr_fill
ws_sum.merge_cells("A7:AE7")
...
q_cols.append(("15-QTR CUMULATIVE", 32, 33))
...
# 15 Standalone Quarter Executive Summary Tables
ws_sum.cell(row=20, column=1, value="INDIVIDUAL QUARTER EXECUTIVE SUMMARY TABLES (ALL 15 QUARTERS)").font = hdr_font
...
wb.save(out_path)
print(f"  • Successfully generated: Nifty211_Past_15_Quarters_Combined_Best_Futures_Master.xlsx")
print("==========================================================================================")
print("PAST 15 QUARTERS COMBINED BEST MASTER WORKBOOK CREATED SUCCESSFULLY!")
print("==========================================================================================")
