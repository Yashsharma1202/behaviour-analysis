...
print("==========================================================================================")
print("BUILDING CLEAN & EASY QUARTERLY PERFORMANCE MASTER WORKBOOK (READING ALL DATA)")
print("==========================================================================================")
...
for q_idx, q_t in enumerate(["Q1", "Q2", "Q3", "Q4"]):
    ...
    headers = [
        "Rank", "Stock Symbol", "Industry Sector", "Strategy", "Action Status",
        "Total History Quarters", "Quarter Data Count", "Position Window", "Win Rate %",
        "Win Ratio", "Losing Quarters", "Average Return %",
        "Margin Capital (₹)", "Net Realised P&L (₹)"
    ]
...
print("==========================================================================================")
print("CLEAN & EASY QUARTERLY PERFORMANCE MASTER WORKBOOK CREATED SUCCESSFULLY!")
print("==========================================================================================")
