...
print("==========================================================================================")
print("BUILDING CLEAN & EASY QUARTERLY PERFORMANCE MASTER V4 (DYNAMIC DEDICATED QUARTERLY WINDOWS)")
print("==========================================================================================")
print("  • Optimizing T-pre to T+post window for EACH quarter individually")
...
for q_idx, q_t in enumerate(["Q1", "Q2", "Q3", "Q4"]):
    ...
    ws["A1"] = f"NIFTY 211 STOCKS - {sheet_title.upper()} DYNAMIC PERFORMANCE MASTER"
    ...
    # Main Ranking Table
    rank_start_row = 6
    ws.cell(row=rank_start_row, column=1, value=f"ALL {len(df_sorted)} STOCKS RANKED BY {sheet_title.upper()} DYNAMIC PERFORMANCE").font = hdr_font
...
try:
    ...
    alt_path = ROOT / "Nifty211_Quarterly_Performance_Master_v4.xlsx"
    wb.save(alt_path)
    print(f"  • WARNING: Nifty211_Quarterly_Performance_Master.xlsx is currently open in Excel!")
    print(f"  • Successfully generated updated file as: Nifty211_Quarterly_Performance_Master_v4.xlsx")
print("==========================================================================================")
print("CLEAN & EASY QUARTERLY PERFORMANCE MASTER V4 CREATED SUCCESSFULLY!")
print("==========================================================================================")
