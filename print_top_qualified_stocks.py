...
ws = wb['Qualified Stocks (69)']

print("==========================================================================================")
print("TOP 15 QUALIFIED STOCKS (>=12 QUARTERS) RANKED BY EMPIRICAL WIN RATE %")
print("==========================================================================================")
...
for r in range(17, 32):
    ...
    print(f"Rank #{rank:<2} | {sym:<12} | {strat:<13} | {n_q:<12} | Win Rate: {wr:<7} | Wins: {w_c}/{w_c+l_c} | 12-Qtr Net P&L: {pnl}")
