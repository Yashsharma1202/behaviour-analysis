...
print("==========================================================================================")
print("BUILDING FOUR QUARTERS RANKED PERFORMANCE MASTER WORKBOOK (4 SEPARATE QUARTER SHEETS)")
print("==========================================================================================")
...
for idx, sym in enumerate(SYMBOLS, 1):
    ...
    # Categorize historical broadcast dates into Q1, Q2, Q3, Q4
    ...
    # Process performance for each quarter type independently
...
out_path = ROOT / "Nifty211_Four_Quarters_Ranked_Performance_Master.xlsx"
...
for q_idx, q_t in enumerate(["Q1", "Q2", "Q3", "Q4"]):
    ...
    # Sort stocks in this quarter strictly by Average Return % descending, then Win Rate % descending, then Net P&L descending
    ...
    ws["A1"] = f"NIFTY 211 STOCKS - {sheet_title.upper()} RANKED PERFORMANCE MASTER"
    ...
    cards = [
        ("TOTAL STOCKS RANKED", f"{len(df_qtype)} Stocks", "A3:B4", "A3"),
    ...
    # Main Ranking Table
    rank_start_row = 6
    ws.cell(row=rank_start_row, column=1, value=f"ALL {len(df_qtype)} STOCKS RANKED BY {q_t} AVERAGE RETURN %").font = hdr_font
    ...
    for r_idx, r in enumerate(df_qtype.to_dict('records'), start=rank_start_row+2):
        ...
        ws.cell(row=r_idx, column=8, value=r['wins'] if r['is_available'] else "N/A").border = border_thin
        ws.cell(row=r_idx, column=8).alignment = Alignment(horizontal="center")
        
        ws.cell(row=r_idx, column=9, value=r['losses'] if r['is_available'] else "N/A").border = border_thin
...
wb.save(out_path)
print(f"  • Successfully generated: Nifty211_Four_Quarters_Ranked_Performance_Master.xlsx")
print("==========================================================================================")
print("FOUR QUARTERS RANKED PERFORMANCE MASTER WORKBOOK CREATED SUCCESSFULLY!")
print("==========================================================================================")
