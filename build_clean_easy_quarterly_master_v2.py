...
print("==========================================================================================")
print("BUILDING CLEAN & EASY QUARTERLY PERFORMANCE MASTER V2 (WITH LISTING / FIRST QUARTER DATA)")
print("==========================================================================================")
...
def get_quarter_name_from_month(m):
    if m in (4, 5, 6): return "Q1 (April Earnings)"
    elif m in (7, 8, 9): return "Q2 (July Earnings)"
    elif m in (10, 11, 12): return "Q3 (October Earnings)"
    else: return "Q4 (January Earnings)"
    ...
    if fr_path.exists() and fr_path.stat().st_size > 10:
        try:
            ...
            if not df_fr.empty and 'broadCastDate' in df_fr.columns:
                ...
                if not df_fr.empty:
                    min_dt = df_fr['dt'].min()
                    first_date_str = min_dt.strftime('%Y-%m-%d')
                    first_q_name = get_quarter_name_from_month(min_dt.month)
...
quarter_names = {
    "Q1": "Q1 April Earnings",
    "Q2": "Q2 July Earnings",
    "Q3": "Q3 October Earnings",
    "Q4": "Q4 January Earnings"
}
...
try:
    ...
    alt_path = ROOT / "Nifty211_Quarterly_Performance_Master_v2.xlsx"
    wb.save(alt_path)
    print(f"  • WARNING: Nifty211_Quarterly_Performance_Master.xlsx is currently open in Excel!")
    print(f"  • Successfully generated updated file as: Nifty211_Quarterly_Performance_Master_v2.xlsx")
print("==========================================================================================")
print("CLEAN & EASY QUARTERLY PERFORMANCE MASTER V2 CREATED SUCCESSFULLY!")
print("==========================================================================================")
