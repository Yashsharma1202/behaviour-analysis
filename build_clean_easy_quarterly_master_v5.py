...
print("==========================================================================================")
print("BUILDING CLEAN & EASY QUARTERLY PERFORMANCE MASTER V5 (REMOVING FIRST REPORTING DATE COLUMN)")
print("==========================================================================================")
print("  • Keeping 'Listing Start Quarter Name' Column")
print("  • Removed 'First Reporting Date / Listing Date' Column as requested")
...
out_path_master = ROOT / "Nifty211_Quarterly_Performance_Master.xlsx"
out_path_dynamic = ROOT / "Nifty211_Dynamic_Quarterly_Performance_Master.xlsx"
...
for q_idx, q_t in enumerate(["Q1", "Q2", "Q3", "Q4"]):
    ...
    # EXACT 15 HEADERS (First Reporting Date / Listing Date REMOVED)
    headers = [
    ...
    for r_idx, r in enumerate(df_sorted.to_dict('records'), start=rank_start_row+2):
        ...
        # Column 4: Listing Start Quarter Name
        ...
        # Column 5: Strategy (Previously Col 6)
        ...
        # Column 6: Action Status (Previously Col 7)
        ...
        # Column 7: Total History Quarters
...
saved_paths = []
for target_path in [out_path_dynamic, out_path_master, ROOT / "Nifty211_Quarterly_Performance_Master_Clean.xlsx"]:
    try:
        wb.save(target_path)
...
print("==========================================================================================")
print(f"CLEAN & EASY QUARTERLY PERFORMANCE MASTER V5 CREATED SUCCESSFULLY! ({len(saved_paths)} files saved)")
print("==========================================================================================")
