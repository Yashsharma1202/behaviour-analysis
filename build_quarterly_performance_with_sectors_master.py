...
print("==========================================================================================")
print("BUILDING QUARTERLY PERFORMANCE WITH SECTORS MASTER WORKBOOK (4 SEPARATE SHEETS)")
print("==========================================================================================")
...
# Industry Sector Mapping Dictionary for all Nifty 211 Stocks
SECTOR_MAP = {
...
out_path = ROOT / "Nifty211_Quarterly_Performance_With_Sectors_Master.xlsx"
...
for q_idx, q_t in enumerate(["Q1", "Q2", "Q3", "Q4"]):
    ...
    ws["A1"] = f"NIFTY 211 STOCKS - {q_t} PERFORMANCE WITH SECTORS & QUARTER BREAKDOWN"
    ...
    # Main Ranking Table
    rank_start_row = 6
    ws.cell(row=rank_start_row, column=1, value=f"ALL {len(df_sorted)} STOCKS RANKED BY {q_t} AVERAGE RETURN % (WITH SECTOR & QUARTER COUNTS)").font = hdr_font
    ...
    headers = [
        ...
        "Total History Quarters", "Specific Quarter Data Count", "Position Window", "Specific Quarter Win Rate %",
...
print("==========================================================================================")
print("QUARTERLY PERFORMANCE WITH SECTORS MASTER WORKBOOK CREATED SUCCESSFULLY!")
print("==========================================================================================")
