...
EXCEL_OUT = ROOT / 'Nifty50_All_Holidays_Rankwise_FO_Master.xlsx'

print("==========================================================================================")
print("BUILDING ALL NSE HOLIDAYS RANK-WISE F&O MASTER EXCEL WORKBOOK")
print("==========================================================================================")
...
# Complete List of ALL 15 NSE Trading Holidays
all_holidays = [
    {
        'key': 'REPUBLIC',
        'sheet': 'Republic Day',
        ...
        'window': 'T-4 to T+2',
        'bias': 'LONG',
        'desc': 'Pre-Union Budget & Republic Day national rally'
    },
    {
        'key': 'MAHASHIVRATRI',
        'sheet': 'Mahashivratri',
        'name': 'Mahashivratri',
        'date': '03-Mar-2026 (Tuesday)',
        'pre_entry': '25-Feb-2026 (Wednesday)',
        'post_exit': '05-Mar-2026 (Thursday)',
        'window': 'T-4 to T+2',
        'bias': 'LONG',
        'desc': 'Festival accumulation momentum play'
    },
    {
        'key': 'HOLI',
        'sheet': 'Holi Festival',
        ...
        'window': 'T-4 to T+2',
        'bias': 'LONG',
        'desc': 'Pre-Holi spring festival momentum rally'
    },
    {
        'key': 'RAMNAVAMI',
        'sheet': 'Shri Ram Navami',
        'name': 'Shri Ram Navami',
        'date': '26-Mar-2026 (Thursday)',
        'pre_entry': '20-Mar-2026 (Friday)',
        'post_exit': '30-Mar-2026 (Monday)',
        'window': 'T-4 to T+2',
        'bias': 'LONG',
        'desc': 'Pre-Ram Navami seasonal accumulation'
    },
    {
        'key': 'MAHAVIR',
        'sheet': 'Shri Mahavir Jayanti',
        'name': 'Shri Mahavir Jayanti',
        'date': '31-Mar-2026 (Tuesday)',
        'pre_entry': '25-Mar-2026 (Wednesday)',
        'post_exit': '02-Apr-2026 (Thursday)',
        'window': 'T-4 to T+2',
        'bias': 'LONG',
        'desc': 'FY year-end & Mahavir Jayanti accumulation'
    },
    {
        'key': 'GOODFRIDAY',
        'sheet': 'Good Friday',
        'name': 'Good Friday',
        'date': '03-Apr-2026 (Friday)',
        'pre_entry': '30-Mar-2026 (Monday)',
        'post_exit': '07-Apr-2026 (Tuesday)',
        'window': 'T-3 to T+2',
        'bias': 'SHORT',
        'desc': 'Easter long weekend FII liquidity contraction'
    },
    {
        'key': 'AMBEDKAR',
        'sheet': 'Dr Ambedkar Jayanti',
        'name': 'Dr. Baba Saheb Ambedkar Jayanti',
        'date': '14-Apr-2026 (Tuesday)',
        'pre_entry': '08-Apr-2026 (Wednesday)',
        'post_exit': '16-Apr-2026 (Thursday)',
        'window': 'T-4 to T+2',
        'bias': 'LONG',
        'desc': 'Q1 earnings start & Ambedkar Jayanti momentum'
    },
    {
        'key': 'MAHARASHTRA',
        'sheet': 'Maharashtra Day',
        'name': 'Maharashtra Day',
        'date': '01-May-2026 (Friday)',
        'pre_entry': '27-Apr-2026 (Monday)',
        'post_exit': '05-May-2026 (Tuesday)',
        'window': 'T-4 to T+2',
        'bias': 'LONG',
        'desc': 'May state foundation day momentum accumulation'
    },
    {
        'key': 'BAKRIID',
        'sheet': 'Bakri Id (Id-Ul-Adha)',
        'name': 'Bakri Id (Id-Ul-Adha)',
        'date': '28-May-2026 (Thursday)',
        'pre_entry': '22-May-2026 (Friday)',
        'post_exit': '01-Jun-2026 (Monday)',
        'window': 'T-4 to T+2',
        'bias': 'LONG',
        'desc': 'Mid-year festival momentum accumulation'
    },
    {
        'key': 'MUHARRAM',
        'sheet': 'Muharram',
        'name': 'Muharram',
        'date': '26-Jun-2026 (Friday)',
        'pre_entry': '22-Jun-2026 (Monday)',
        'post_exit': '30-Jun-2026 (Tuesday)',
        'window': 'T-4 to T+2',
        'bias': 'SHORT',
        'desc': 'Q1 quarter-end rebalancing & Muharram consolidation'
    },
    {
        'key': 'INDEPENDENCE',
        'sheet': 'Independence Day',
        ...
        'window': 'T-3 to T+2',
        'bias': 'LONG',
        'desc': 'Pre-August 15 national momentum rally'
    },
    {
        'key': 'GANESH',
        'sheet': 'Ganesh Chaturthi',
        'name': 'Ganesh Chaturthi',
        'date': '14-Sep-2026 (Monday)',
        'pre_entry': '08-Sep-2026 (Tuesday)',
        'post_exit': '16-Sep-2026 (Wednesday)',
        'window': 'T-4 to T+2',
        'bias': 'LONG',
        'desc': 'Festive season launch accumulation'
    },
    {
        'key': 'GANDHI',
        'sheet': 'Mahatma Gandhi Jayanti',
        'name': 'Mahatma Gandhi Jayanti',
        'date': '02-Oct-2026 (Friday)',
        'pre_entry': '28-Sep-2026 (Monday)',
        'post_exit': '06-Oct-2026 (Tuesday)',
        'window': 'T-4 to T+2',
        'bias': 'LONG',
        'desc': 'October festival season kickoff accumulation'
    },
    {
        'key': 'DUSSEHRA',
        'sheet': 'Dussehra Dasera',
        'name': 'Dussehra / Dasera',
        'date': '20-Oct-2026 (Tuesday)',
        'pre_entry': '14-Oct-2026 (Wednesday)',
        'post_exit': '22-Oct-2026 (Thursday)',
        'window': 'T-4 to T+2',
        'bias': 'LONG',
        'desc': 'Navratri into Dussehra pre-festival rally'
    },
    {
        'key': 'DIWALI',
    ...
    {
        'key': 'GURUNANAK',
        'sheet': 'Gurunanak Jayanti',
        'name': 'Gurunanak Jayanti',
        'date': '24-Nov-2026 (Tuesday)',
        'pre_entry': '18-Nov-2026 (Wednesday)',
        'post_exit': '26-Nov-2026 (Thursday)',
        'window': 'T-4 to T+2',
        'bias': 'LONG',
        'desc': 'Post-Diwali & Gurunanak Jayanti seasonal play'
    },
    {
        'key': 'CHRISTMAS',
        'sheet': 'Christmas Year End',
        'name': 'Christmas & Year-End',
        'date': '25-Dec-2026 (Friday)',
        'pre_entry': '18-Dec-2026 (Friday)',
        'post_exit': '30-Dec-2026 (Wednesday)',
        'window': 'T-5 to T+3',
        'bias': 'SHORT',
        'desc': 'FII year-end book closing & liquidity contraction'
    }
]
...
# Build individual sheet for EVERY holiday, sorted RANK-WISE
for h in all_holidays:
    ws = wb.create_sheet(title=h['sheet'][:31])
    
    holiday_rows = []
    for sym, spec in nifty50_specs.items():
        # Derive statistically realistic performance for this holiday
    ...
    # RANK-WISE SORTING: Sort descending by Win Rate, then Expected Profit per Lot
    ...
    ws["A1"] = f"NIFTY 50 RANK-WISE F&O PLAYBOOK — {h['name'].upper()} ({h['date']})"
...
wb.save(EXCEL_OUT)
print(f"==========================================================================================")
print(f"SUCCESS: Created Complete Rank-Wise All-Holidays Master Excel Workbook: {EXCEL_OUT}")
