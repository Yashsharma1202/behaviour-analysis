...
print("==========================================================================================")
print("BUILDING DEDICATED COMBINED BEST PAST 4 QUARTERS FUTURES MASTER WORKBOOK (V5)")
print("==========================================================================================")
...
for idx, sym in enumerate(SYMBOLS, 1):
    ...
    # Compute Historical Win Rates and Expected Mean Returns for both Long and Short
...
out_path = ROOT / "Nifty211_Past_4_Quarters_Combined_Best_Futures_Master_v5.xlsx"
...
INITIAL_PORTFOLIO_FUND = 10000000.0
...
cards = [
    ...
    ("TOTAL STRATEGY RETURN %", f"{total_fund_ret_pct}%", "E3:F4", "E3"),
...
for q_name, _ in quarters_list:
    ...
    ws_q["A1"] = f"NIFTY 211 STOCKS - {q_name} COMBINED BEST FUTURES MASTER (DIRECTIONAL OPTIMIZATION)"
...
wb.save(out_path)
print(f"  • Successfully generated: Nifty211_Past_4_Quarters_Combined_Best_Futures_Master_v5.xlsx")
print("==========================================================================================")
print("DEDICATED COMBINED BEST MASTER WORKBOOK V5 CREATED SUCCESSFULLY!")
print("==========================================================================================")
